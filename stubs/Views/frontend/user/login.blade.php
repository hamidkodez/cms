            ...
            <div class="col-lg-12 col-md-12 p-4 px-5 signup-black min-vh-100">
                <form class="row g-3" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="col-12 form-group mb-3">
                        <label class="phone form-label text-white" for="phone">Phone Number</label>
                        <input class="form-control @error('phone') is-invalid @enderror" placeholder="+996 000-0000" id="phone" name="phone" type="text">
                        @error('phone')
